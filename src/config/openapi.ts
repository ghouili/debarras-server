export const openapiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "CRM REST API for users, contacts, devis, and email messages with JWT authentication."
  },
  servers: [{ url: "/api" }],
  tags: [
  ...
  paths: {
    "/auth/register": {
      post: {
        ...
        description:
          "Creates a new user account and returns tokens. Password must include upper, lower, and number with min length 8. Email must be unique.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
